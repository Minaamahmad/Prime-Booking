export default function Button({ disabled = false, onClick }) {
  ...
  return (
    <button
      ...
      className={`group relative w-full max-w-xs rounded-full border border-indigo-700 bg-indigo-600 px-6 py-3 font-bold text-white transition-all duration-300 ${disabled
